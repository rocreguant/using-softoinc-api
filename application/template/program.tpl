...
{* SMARTY *}
				<div class="post">
					<h2>{$programa['title']}</a></h2>
					<p class="postmeta">Licencia: {$programa['license']} | Actualizado: {$programa['date_updated']} </p>
					<div class="entry">
						{$programa['review_html']}
					</div>url_download
					<h3> <a href="{$programa['url_download']}">Descargar </a></h3>
				</div><!-- post -->
        </div><!-- content -->
