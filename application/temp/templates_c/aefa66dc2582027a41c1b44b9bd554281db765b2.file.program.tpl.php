<?php /* Smarty version Smarty-3.1.7, created on 2012-02-02 14:06:55
         compiled from "E:\xampp\htdocs\project\application\template\program.tpl" */ ?>
<?php /*%%SmartyHeaderCode:36154f2a87de305675-11560849%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aefa66dc2582027a41c1b44b9bd554281db765b2' => 
    array (
      0 => 'E:\\xampp\\htdocs\\project\\application\\template\\program.tpl',
      1 => 1328187978,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '36154f2a87de305675-11560849',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_4f2a87de4039f',
  'variables' => 
  array (
    'programs' => 0,
    'program' => 0,
...
<?php if ($_valid && !is_callable('content_4f2a87de4039f')) {function content_4f2a87de4039f($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'E:\\xampp\\htdocs\\project\\application\\libs\\smarty\\plugins\\modifier.replace.php';
...
<!-- Posts o resultats, en definitiva el contingut -->		
        <div id="content">  
				...
				<div class="post">
					<h2><?php echo $_smarty_tpl->tpl_vars['programa']->value['title'];?>
</a></h2>
					<p class="postmeta">Licencia: <?php echo $_smarty_tpl->tpl_vars['programa']->value['license'];?>
 | Actualizado: <?php echo $_smarty_tpl->tpl_vars['programa']->value['date_updated'];?>
 </p>
					<div class="entry">
						<?php echo $_smarty_tpl->tpl_vars['programa']->value['review_html'];?>

					</div>url_download
					<h3> <a href="<?php echo $_smarty_tpl->tpl_vars['programa']->value['url_download'];?>
">Descargar </a></h3>
				</div><!-- post -->
        </div><!-- content -->
